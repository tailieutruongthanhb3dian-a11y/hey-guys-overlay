...
export const vi = {
  "warn.hotkey_summary": "Một số phím tắt đang được ứng dụng khác sử dụng. Bạn có thể đổi trong Cài đặt.",
  "warn.hotkey_details": "Xem phím bị trùng",
  "era.invite_sent": "Đã gửi lời mời cho {name}.",
  "era.connected_hint": "Tìm bạn, nhận lời mời và mở bảng ERA ngay tại đây.",
  "tab.era": "ERA & Bạn bè",
  "quick.detail_era": "Kết nối ERA, tìm bạn, nhận lời mời",
  "era.title": "Vào ERA. Chơi cùng bạn.",
  "era.subtitle": "Server của bạn đã chọn sẵn. Kết nối Steam để bắt đầu.",
  "era.connected": "Đã kết nối ERA",
  "era.not_connected": "Chưa kết nối",
  "era.connect_title": "Kết nối ERA bằng Steam",
  "era.connect_hint": "Dùng tài khoản Steam bạn chơi trên ERA. Phiên ERA riêng với IslePilot; không cần chép token hay cookie.",
  "era.connect": "Kết nối Steam · ERA",
  "era.waiting_steam": "Đang chờ Steam…",
  "era.complete_steam": "Hoàn tất đăng nhập trong cửa sổ ERA. Danh sách bạn bè sẽ tự hiện khi kết nối xong.",
  "era.check_session": "Tôi đã đăng nhập · kiểm tra lại",
  "era.network_error": "Chưa kết nối được ERA. Kiểm tra mạng rồi thử lại.",
  "era.login_timeout": "Chưa nhận được phiên đăng nhập. Bấm kết nối để thử lại.",
  "era.find_friends": "Tìm người chơi cùng",
  "era.find_hint": "Nhập tên người đang online trên ERA, rồi bấm Kết bạn.",
  "era.search_placeholder": "Tên người chơi trên ERA…",
  "era.search": "Tìm bạn",
  "era.searching": "Đang tìm…",
  "era.add": "Kết bạn",
  "era.already_related": "Đã có trong danh sách",
  "era.no_results": "Chưa tìm thấy. Thử tên khác hoặc nhờ bạn vào server ERA.",
  "era.incoming": "Lời mời đến",
  "era.accept": "Chấp nhận",
  "era.decline": "Từ chối",
  "era.no_incoming": "Chưa có lời mời mới.",
  "era.friends": "Bạn bè của bạn",
  "era.refresh": "Làm mới",
  "era.online": "Đang online",
  "era.offline": "Ngoại tuyến",
  "era.remove": "Xóa bạn",
  "era.remove_confirm": "Hủy kết bạn với {name}? Hai bên sẽ không còn thấy vị trí của nhau.",
  "era.no_friends": "Bạn bè đã chấp nhận sẽ xuất hiện ở đây.",
  "era.outgoing": "Lời mời đã gửi",
  "era.cancel": "Hủy lời mời",
  "era.live_title": "Live Map · Garage · Phối màu ERA",
  "era.live_hint": "Mở bảng điều khiển chính thức của ERA trong app, dùng cùng phiên Steam.",
  "era.open_live": "Mở bảng ERA",
  "layers.show_all": "Bật hết",
  "layers.hide_all": "Tắt hết",
  "layers.undo": "Hoàn tác",
  "layers.save_failed": "Chưa lưu được lớp bản đồ. Hãy thử lại.",
  // --- chung ---
  "app.title": "Hey Guys Overlay",
  "app.minimap_title": "Bản đồ nhỏ",
  "app.fullmap_title": "Bản đồ Gateway",
  "app.steam_connecting": "Đang kết nối…",
  "app.subtitle": "Trợ lý chiến thuật Gateway",
  "app.map_ready": "Dữ liệu bản đồ đã sẵn sàng",
  "app.map_syncing": "Đang chuẩn bị dữ liệu bản đồ",
  "app.ready": "SẴN SÀNG",
  "app.sync": "ĐANG TẢI",
  "app.login_help": "Xem cách khắc phục",

  // --- bảng lệnh nhanh ---
  "quick.open": "Mở nhanh",
  "quick.eyebrow": "TRUY CẬP NHANH",
  "quick.title": "Bạn muốn làm gì?",
  "quick.placeholder": "Tìm bản đồ, Garage, Steam, cài đặt…",
  "quick.empty": "Không tìm thấy tính năng phù hợp.",
  "quick.navigate": "Di chuyển",
  "quick.select": "Chọn",
  "quick.detail_map": "Xem bản đồ, địa danh, POI và waypoint",
  "quick.detail_dino": "Xem chỉ số và nhiệm vụ của khủng long",
  "quick.detail_garage": "Quản lý khủng long đang gửi trong Garage",
  "quick.detail_skin": "Phối màu, xem trước 3D và lưu tối đa 3 bộ skin",
  "quick.detail_settings": "Tùy chỉnh minimap, phím tắt và giao diện",
  "quick.detail_guide": "Xem hướng dẫn sử dụng từng bước",
  "quick.detail_donate": "Thông tin ứng dụng và nhóm phát triển",
  "quick.steam_open": "Mở tài khoản Steam",
  "quick.steam_connected": "Steam đã kết nối — mở thông tin tài khoản",
  "quick.steam_detail": "Kết nối một lần để mở khóa dữ liệu IslePilot",
  ...
  "tab.garage": "Garage",
  "tab.skin": "Skin Studio",
  "tab.guide": "Hướng dẫn",
  "tab.donate": "Giới thiệu",
  "skin.title": "Xưởng skin khủng long",
  "skin.subtitle": "Phối màu trực tiếp trên mô hình 3D, lưu mẫu rồi áp dụng khi bạn đã ưng ý.",
  "skin.dino_online": "Đã nhận khủng long đang chơi",
  "skin.dino_offline": "Chưa thấy khủng long trong game",
  "skin.preview": "Xem trước 3D",
  "skin.species": "Loài khủng long",
  "skin.rotate_hint": "Giữ chuột để xoay · Lăn để thu phóng",
  "skin.vip": "Màu HEX tự do",
  "skin.free": "Bảng màu tiêu chuẩn",
  "skin.checking": "Đang kiểm tra quyền skin…",
  "skin.cooldown": "Có thể đổi lại sau {time}",
  "skin.ready": "Sẵn sàng áp dụng vào game",
  "skin.enter_game": "Vào server để áp dụng skin",
  "skin.apply": "Áp dụng skin",
  "skin.applying": "Đang áp dụng…",
  "skin.applied": "Skin đã được áp dụng thành công.",
  "skin.unavailable": "Tính năng đổi skin hiện chưa khả dụng.",
  "skin.login_required": "Hãy đăng nhập ERA để dùng tính năng đổi skin.",
  "skin.policy_error": "Không đọc được quyền đổi skin từ ERA.",
  "skin.apply_error": "Không thể áp dụng skin. Hãy kiểm tra game và thử lại.",
  "skin.crashed": "Skin Studio gặp lỗi khi dựng giao diện.",
  "skin.colors": "Phối màu",
  "skin.reset": "Màu mặc định",
  "skin.preset_jungle": "Rừng sâu",
  "skin.preset_ember": "Dung nham",
  "skin.preset_royal": "Hoàng gia",
  "skin.zone_body": "Thân",
  "skin.zone_markings": "Lưng",
  "skin.zone_display": "Màng cánh",
  "skin.zone_flank": "Cổ",
  "skin.zone_underbelly": "Mõm",
  "skin.zone_detail": "Đuôi",
  "skin.zone_eyes": "Chân & mắt",
  "skin.saved_skins": "Skin đã lưu",
  "skin.empty_slot": "Ô trống",
  "skin.not_saved": "Chưa lưu skin",
  "skin.delete_slot": "Xóa skin ở ô {slot}",
  "skin.name_placeholder": "Tên bộ skin…",
  "skin.save_slot": "Lưu vào ô {slot}",
  "skin.storage_hint": "Ba bộ skin được lưu trên máy này và vẫn còn sau khi mở lại ứng dụng.",
  "skin.loaded": "Đã mở skin ở ô {slot} để xem trước.",
  "skin.slot_default": "Skin {slot}",
  "skin.saved": "Đã lưu skin vào ô {slot}.",
  "skin.deleted": "Đã xóa skin ở ô {slot}.",
  ...
  "layer.plants": "Cây / thực vật (Atlas)",
  "layer.atlas_animals": "Điểm thú tĩnh (Atlas)",
  "layer.atlas_locations": "Địa điểm (Atlas)",
  "layer.atlas_labels": "Địa danh (Atlas)",
  "layer.atlas_zones": "Vùng (Atlas)",
  "layer.atlas_spawns": "Điểm spawn (Atlas)",
  ...
  "hotkey.cycle_layout": "Chuyển bố cục HUD đã lưu",
  ...
  "dino.connected_hint": "Đã kết nối tài khoản IslePilot qua Steam; dữ liệu tự đi theo server bạn đang chơi.",
  "dino.login_benefits": "Lợi ích đăng nhập Steam",
  "dino.login_once": "Chỉ đăng nhập một lần",
  "dino.login_all_servers": "Tự nhận mọi server IslePilot",
  "dino.login_secure": "Token được Windows mã hóa",
  "dino.advanced_login": "Không đăng nhập được? Mở tùy chọn nâng cao",
