...
export const en: Record<MsgKey, string> = {
  "warn.hotkey_summary": "Some shortcuts are in use by another app. You can change them in Settings.",
  "warn.hotkey_details": "Show conflicting shortcuts",
  "era.invite_sent": "Invitation sent to {name}.",
  "era.connected_hint": "Find friends, accept invitations and open your ERA dashboard here.",
  "tab.era": "ERA & Friends",
  "quick.detail_era": "Connect ERA, find friends, accept invitations",
  "era.title": "Join ERA. Play together.",
  "era.subtitle": "Your server is selected. Connect Steam to get started.",
  "era.connected": "Connected to ERA",
  "era.not_connected": "Not connected",
  "era.connect_title": "Connect ERA with Steam",
  "era.connect_hint": "Use the Steam account you play on ERA. ERA and IslePilot have separate sessions; no tokens or cookies to copy.",
  "era.connect": "Connect Steam · ERA",
  "era.waiting_steam": "Waiting for Steam…",
  "era.complete_steam": "Finish signing in in the ERA window. Your friends will appear automatically.",
  "era.check_session": "Already signed in · check again",
  "era.network_error": "Cannot reach ERA. Check your connection and retry.",
  "era.login_timeout": "Sign-in has not completed. Connect again to retry.",
  "era.find_friends": "Find someone to play with",
  "era.find_hint": "Search for an online ERA player, then select Add friend.",
  "era.search_placeholder": "Player name on ERA…",
  "era.search": "Find friends",
  "era.searching": "Searching…",
  "era.add": "Add friend",
  "era.already_related": "Already listed",
  "era.no_results": "No players found. Try another name or ask your friend to join ERA.",
  "era.incoming": "Invitations",
  "era.accept": "Accept",
  "era.decline": "Decline",
  "era.no_incoming": "No new invitations.",
  "era.friends": "Your friends",
  "era.refresh": "Refresh",
  "era.online": "Online",
  "era.offline": "Offline",
  "era.remove": "Remove",
  "era.remove_confirm": "Remove {name}? You will no longer see each other's position.",
  "era.no_friends": "Accepted friends will appear here.",
  "era.outgoing": "Sent invitations",
  "era.cancel": "Cancel invitation",
  "era.live_title": "ERA Live Map · Garage · Skins",
  "era.live_hint": "Open ERA's official dashboard inside the app using the same Steam session.",
  "era.open_live": "Open ERA dashboard",
  "layers.show_all": "Show all",
  "layers.hide_all": "Hide all",
  "layers.undo": "Undo",
  "layers.save_failed": "Could not save map layers. Please try again.",
  "app.title": "Hey Guys Overlay",
  "app.minimap_title": "Minimap",
  "app.fullmap_title": "Gateway Map",
  "app.steam_connecting": "Connecting…",
  "app.subtitle": "Gateway tactical companion",
  "app.map_ready": "Map data is ready",
  "app.map_syncing": "Preparing map data",
  "app.ready": "READY",
  "app.sync": "SYNCING",
  "app.login_help": "Troubleshoot",

  "quick.open": "Quick access",
  "quick.eyebrow": "QUICK ACCESS",
  "quick.title": "What would you like to do?",
  "quick.placeholder": "Find Map, Garage, Steam, settings…",
  "quick.empty": "No matching feature found.",
  "quick.navigate": "Navigate",
  "quick.select": "Select",
  "quick.detail_map": "View the map, locations, POIs and waypoints",
  "quick.detail_dino": "See your dino's stats and quests",
  "quick.detail_garage": "Manage dinos parked in the Garage",
  "quick.detail_skin": "Mix colors, preview in 3D and save up to 3 skins",
  "quick.detail_settings": "Customize the minimap, hotkeys and interface",
  "quick.detail_guide": "Open the step-by-step user guide",
  "quick.detail_donate": "Application and development team",
  "quick.steam_open": "Open Steam account",
  "quick.steam_connected": "Steam is connected — open account details",
  "quick.steam_detail": "Connect once to unlock IslePilot data",
  ...
  "tab.guide": "Guide",
  "tab.donate": "About",
  "skin.title": "Dinosaur Skin Studio",
  "skin.subtitle": "Mix colors on the live 3D model, save a design, then apply it when it looks right.",
  "skin.dino_online": "Current dinosaur detected",
  "skin.dino_offline": "No dinosaur detected in game",
  "skin.preview": "3D preview",
  "skin.species": "Dinosaur species",
  "skin.rotate_hint": "Drag to rotate · Scroll to zoom",
  "skin.vip": "Free HEX colors",
  "skin.free": "Standard palette",
  "skin.checking": "Checking skin access…",
  "skin.cooldown": "Change again in {time}",
  "skin.ready": "Ready to apply in game",
  "skin.enter_game": "Join a server to apply the skin",
  "skin.apply": "Apply skin",
  "skin.applying": "Applying…",
  "skin.applied": "Skin applied successfully.",
  "skin.unavailable": "Skin changes are currently unavailable.",
  "skin.login_required": "Sign in to ERA to use skin changes.",
  "skin.policy_error": "Could not read skin access from ERA.",
  "skin.apply_error": "Could not apply the skin. Check the game and try again.",
  "skin.crashed": "Skin Studio encountered an error while rendering.",
  "skin.colors": "Color mix",
  "skin.reset": "Default colors",
  "skin.preset_jungle": "Jungle",
  "skin.preset_ember": "Ember",
  "skin.preset_royal": "Royal",
  "skin.zone_body": "Body",
  "skin.zone_markings": "Back",
  "skin.zone_display": "Wing membrane",
  "skin.zone_flank": "Neck",
  "skin.zone_underbelly": "Snout",
  "skin.zone_detail": "Tail",
  "skin.zone_eyes": "Legs & eyes",
  "skin.saved_skins": "Saved skins",
  "skin.empty_slot": "Empty slot",
  "skin.not_saved": "No skin saved",
  "skin.delete_slot": "Delete skin in slot {slot}",
  "skin.name_placeholder": "Skin name…",
  "skin.save_slot": "Save to slot {slot}",
  "skin.storage_hint": "Your three skins are saved on this PC and remain after reopening the app.",
  "skin.loaded": "Loaded skin from slot {slot} for preview.",
  "skin.slot_default": "Skin {slot}",
  "skin.saved": "Saved skin to slot {slot}.",
  "skin.deleted": "Deleted skin from slot {slot}.",
  ...
  "layer.plants": "Plants (Atlas)",
  "layer.atlas_animals": "Animal sites — static (Atlas)",
  "layer.atlas_locations": "Locations (Atlas)",
  "layer.atlas_labels": "Place names (Atlas)",
  "layer.atlas_zones": "Zones (Atlas)",
  "layer.atlas_spawns": "Spawn sites (Atlas)",
  ...
  "hotkey.cycle_layout": "Cycle saved HUD layouts",
  ...
  "dino.connected_hint": "Your IslePilot account is connected through Steam; data follows your game server.",
  "dino.login_benefits": "Steam sign-in benefits",
  "dino.login_once": "Sign in only once",
  "dino.login_all_servers": "Detect every IslePilot server automatically",
  "dino.login_secure": "Token encrypted by Windows",
  "dino.advanced_login": "Can't sign in? Open advanced options",
